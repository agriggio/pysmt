...
z3.is_arr_select = lambda x: z3.is_app_of(x, z3.Z3_OP_SELECT)
z3.is_arr_store = lambda x: z3.is_app_of(x, z3.Z3_OP_STORE)
...
class Z3Converter(Converter, DagWalker):
    ...
    def _back_single_term(self, expr, args):
        ...
        elif z3.is_arr_select(expr):
            res = self.mgr.ArrSelect(args[0], args[1])
        elif z3.is_arr_store(expr):
            res = self.mgr.ArrStore(args[0], args[1], args[2])
