...
class Walker(object):
    ...
    def __init__(self, env=None):
        ...
        self.functions[op.ARR_SELECT] = self.walk_arr_select
        self.functions[op.ARR_STORE] = self.walk_arr_store
    ...
    def walk_arr_select(self, formula, **kwargs):
        return self.walk_error(formula, **kwargs)

    def walk_arr_store(self, formula, **kwargs):
        return self.walk_error(formula, **kwargs)
